                    ...
                    decoration: InputDecoration(
                      suffixIcon: GestureDetector(
                        ...
                        child: Icon(
                          ...
                          color: _isPasswordVisible ? Colors.grey : AppColors.merahTua,
                        ),
                      ),
                  ...
                  TextFormField(
                    decoration: InputDecoration(
                      suffixIcon: GestureDetector(
                        ...
                        child: Icon(
                          Icons.remove_red_eye_outlined,
                          color: _isConfirmPasswordVisible ? Colors.grey : AppColors.merahTua,
                        ),
                      ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (_signupFormKey.currentState!.validate()) {
                          register(request, username, password, confirmPassword, role, context, mounted);
                        }
                      },
